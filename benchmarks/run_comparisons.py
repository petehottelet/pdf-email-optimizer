...
- ``pdf-email-optimizer`` at quality, balanced, aggressive, and compress profiles
...
def main() -> int:
    ...
    # --compress is the "force a filesize, keep RGB" profile. Run it at a
    ...
    print("-> optimizer (compress --target-mb 1) ...", flush=True)
    rows.append(run_optimizer(source, 1.0, "compress", output_dir))
